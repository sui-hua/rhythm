...
alter table "public"."daily_plans" drop constraint "daily_plans_status_check";

alter table "public"."monthly_plans" drop constraint "monthly_plans_status_check";

alter table "public"."plans" drop constraint "plans_status_check";

alter table "public"."summaries" drop constraint "summaries_scope_check";

alter table "public"."daily_plans" add constraint "daily_plans_status_check" CHECK (((status)::text = ANY ((ARRAY['active'::character varying, 'completed'::character varying, 'archived'::character varying])::text[]))) not valid;

alter table "public"."daily_plans" validate constraint "daily_plans_status_check";

alter table "public"."monthly_plans" add constraint "monthly_plans_status_check" CHECK (((status)::text = ANY ((ARRAY['active'::character varying, 'completed'::character varying, 'archived'::character varying])::text[]))) not valid;

alter table "public"."monthly_plans" validate constraint "monthly_plans_status_check";

alter table "public"."plans" add constraint "plans_status_check" CHECK (((status)::text = ANY ((ARRAY['active'::character varying, 'completed'::character varying, 'archived'::character varying])::text[]))) not valid;

alter table "public"."plans" validate constraint "plans_status_check";

alter table "public"."summaries" add constraint "summaries_scope_check" CHECK (((scope)::text = ANY ((ARRAY['year'::character varying, 'quarter'::character varying, 'month'::character varying, 'week'::character varying])::text[]))) not valid;

alter table "public"."summaries" validate constraint "summaries_scope_check";
