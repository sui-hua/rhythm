<template>
  ...
  >
    ...
    <Badge variant="outline" class="ml-8 text-[9px] font-black text-red-600 uppercase tracking-[0.3em] border-red-200 bg-red-50/80 backdrop-blur-sm hover:bg-red-50 px-2 py-0.5 shadow-sm">
      现在
    </Badge>
  </div>
</template>
